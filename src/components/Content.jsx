      ...
      <section className="container py-5">
        ...
        <div className="row">
            <div className="col-12 col-md-3 p-5 mt-3">
                <a href="#"><img src="./assets/img/rang-ca-phe-hat5.jpg" className="rounded-circle img-fluid border" alt="Cà Phê Hạt Rang"/></a>
                <h5 className="text-center mt-3 mb-3">Cà Phê Hạt Rang</h5>
                <p className="text-center"><a className="btn btn-success">Đặt Hàng</a></p>
            </div>
            <div className="col-12 col-md-3 p-5 mt-3">
                <a href="#"><img src="./assets/img/caphebotxay.jpg" className="rounded-circle img-fluid border" alt="Cà Phê Bột Xay"/></a>
                <h2 className="h5 text-center mt-3 mb-3">Cà Phê Bột Xay</h2>
                <p className="text-center"><a className="btn btn-success">Đặt Hàng</a></p>
            </div>
            <div className="col-12 col-md-3 p-5 mt-3">
                <a href="#"><img src="./assets/img/hopquacaphe.jpg" className="rounded-circle img-fluid border" alt="Hộp Quà Cà Phê"/></a>
                <h2 className="h5 text-center mt-3 mb-3">Hộp Quà Cà Phê</h2>
                <p className="text-center"><a className="btn btn-success">Đặt Hàng</a></p>
            </div>
            <div className="col-12 col-md-3 p-5 mt-3">
                <a href="#"><img src="./assets/img/caphephingiay.jpg" className="rounded-circle img-fluid border" alt="Cà Phê Phin Giấy"/></a>
                <h2 className="h5 text-center mt-3 mb-3">Cà Phê Phin Giấy</h2>
                <p className="text-center"><a className="btn btn-success">Đặt Hàng</a></p>
            </div>
            <div className="col-12 col-md-3 p-5 mt-3">
                <a href="#"><img src="./assets/img/caphetuiloc.jpg" className="rounded-circle img-fluid border" alt="Cà Phê Túi Lọc"/></a>
                <h2 className="h5 text-center mt-3 mb-3">Cà Phê Túi Lọc <br/></h2>
                <p className="text-center"><a className="btn btn-success">Đặt Hàng</a></p>
            </div>
            <div className="col-12 col-md-3 p-5 mt-3">
                <a href="#"><img src="./assets/img/caphedenhoatanmix.jpg" className="rounded-circle img-fluid border" alt="Cà Phê Tan Đen & Mix"/></a>
                <h2 className="h5 text-center mt-3 mb-3">Cà Phê Tan Đen & Mix</h2>
                <p className="text-center"><a className="btn btn-success">Đặt Hàng</a></p>
            </div>
            <div className="col-12 col-md-3 p-5 mt-3">
                <a href="#"><img src="./assets/img/tratraicayhoatan.jpg" className="rounded-circle img-fluid border" alt="Trà Trái Cây Nhiệt Đới Hoà Tan"/></a>
                <h2 className="h5 text-center mt-3 mb-3">Trà Trái Cây Nhiệt Đới Hoà Tan</h2>
                <p className="text-center"><a className="btn btn-success">Đặt Hàng</a></p>
            </div>
            <div className="col-12 col-md-3 p-5 mt-3">
                <a href="#"><img src="./assets/img/traicay.png" className="rounded-circle img-fluid border" alt="Trái Cây Sấy Giòn"/></a>
